...
class ShopAdapter(val listShop:List<Int>, val context: Context): RecyclerView.Adapter<ShopAdapter.VHDataShop>() {
    ...
    inner class VHDataShop(val view: View) : RecyclerView.ViewHolder(view){
        val imageViewShop: ImageView = view.findViewById(R.id.ivCode)
        @RequiresApi(Build.VERSION_CODES.LOLLIPOP)

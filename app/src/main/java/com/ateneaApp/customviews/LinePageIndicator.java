...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!isInEditMode()) {
            ...
            index = 1;
            this.mCentered = obtainStyledAttributes.getBoolean(index,z);
            index = 3;
            this.mLineWidth = obtainStyledAttributes.getDimension(index, dimension);
            index = 2;
            this.mGapWidth = obtainStyledAttributes.getDimension(index, dimension2);
            index = 5;
            setStrokeWidth(obtainStyledAttributes.getDimension(index, dimension3));
            index = 6;
            this.mPaintUnselected.setColor(obtainStyledAttributes.getColor(index, color2));
            index = 4;
            this.mPaintSelected.setColor(obtainStyledAttributes.getColor(index, color));
